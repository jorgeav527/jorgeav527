...
{{< details summary="How AWS Basic Support works?" >}}
- **Free for All AWS Customers**
- **Access to Resources**:
  - Whitepapers
  - Documentation
  - Support communities
- **Billing and Service Limit Support**:
  - Contact AWS for billing questions
  - Request service limit increases
- **AWS Trusted Advisor**:
  - Limited selection of checks available
- **AWS Personal Health Dashboard**:
  - Receive alerts and remediation guidance during AWS events
{{< /details >}}

{{< details summary="How AWS Developer Support works?" >}}
- **Best Practice Guidance**
- **Client-Side Diagnostic Tools**
- **Building-Block Architecture Support**:
  - Guidance on how to integrate AWS offerings, features, and services
  - Helps identify opportunities to combine specific services to meet your company's needs
{{< /details >}}

{{< details summary="How AWS Business Support works?" >}}
- **Use-Case Guidance**
  - Helps identify AWS offerings, features, and services best suited to your specific needs
- **All AWS Trusted Advisor Checks**
- **Limited Third-Party Software Support**
  - Assistance with common operating systems and application stack components
  - For advanced topics like performance optimization, custom scripts, or security issues, direct support from the software provider may be needed
{{< /details >}}

{{< details summary="How AWS Enterprise On-Ramp Support works?" >}}
- **Access to a Pool of Technical Account Managers**
  - Proactive guidance and coordination with AWS programs and experts
- **Cost Optimization Workshop**
  - Conducted once per year
- **Concierge Support Team**
  - Billing and account assistance
- **Monitoring Tools**
  - Track costs and performance through Trusted Advisor and Health API/Dashboard
- **Proactive Support Services**
  ...
  - Business-critical issue response time of 30 minutes or less
{{< /details >}}

{{< details summary="How AWS Enterprise Support works?" >}}
- **Designated Technical Account Manager**
  - Provides proactive guidance and coordinates access to programs and AWS experts
- **Concierge Support Team**
  - Billing and account assistance
- **Operations Reviews and Health Monitoring Tools**
  - Track the health of your environment
- **Training and Game Days**
  - Initiatives to drive innovation
- **Monitoring Tools**
  - Track costs and performance via Trusted Advisor and Health API/Dashboard
- **Full Access to Proactive Services** (provided by a designated Technical Account Manager):
...
### AWS Snow Family
  - Internet transfer and Direct Connect can be slow and costly for huge data volumes
